    ...
    fetch("http://127.0.0.1:3001/auth/reset-password", {
      ...
      .then((data) => {
        if (data.success) {
          ...
          setErrorMessage(data.error || "Erro ao redefinir a Password. Verifique os dados inseridos.");
        }
      })
      .catch((error) => {
        console.error("Erro:", error);
        setErrorMessage("Erro ao redefinir a Password. Verifique os dados inseridos.");
      });
  };
